...
import 'package:edvolutionhub/screens/feaures/topic_selections.dart';
import 'package:flutter/material.dart';
import 'package:edvolutionhub/models/user_models.dart'; // Make sure this contains the AuthService
// import 'package:edvolutionhub/services/database_service.dart'; // Assuming DatabaseService is implemented
  ...
  Future<void> _register() async {
    ...
    if (result ==  null || result_2 == null) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const InterestsSelectionPage()));
    }
  }
